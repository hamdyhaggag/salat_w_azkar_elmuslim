...
class Pray14 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const Scaffold(
      appBar: CustomAppBar(title: ' الأذكار بعد السلام '),
      body: SingleChildScrollView(
        child: Column(
          children: [
            SizedBox(height: 15),
            CustomContainer(
                title: 'أستغفر الله', maxValue: 3, initialCounterValue: 0),
            SizedBox(height: 15),
            CustomContainer(
                title:
            ...
            SizedBox(height: 15),
            CustomContainer(
                title: 'سبحان الله', maxValue: 33, initialCounterValue: 0),
            SizedBox(height: 15),
            CustomContainer(
                title: 'الحمد لله', maxValue: 33, initialCounterValue: 0),
            SizedBox(height: 15),
            CustomContainer(
                title: 'الله أكبر', maxValue: 33, initialCounterValue: 0),
            SizedBox(height: 15),
            CustomContainer(
                title:
            ...
            SizedBox(height: 15),
            CustomContainer(
                headtitle: 'بسم الله الرحمن الرحيم',
                title:
            ...
            SizedBox(height: 15),
            CustomContainer(
                title: 'الحمد لله', maxValue: 10, initialCounterValue: 0),
            SizedBox(height: 15),
            CustomContainer(
                title: 'سبحان الله', maxValue: 10, initialCounterValue: 0),
            SizedBox(height: 15),
            CustomContainer(
                title: 'الله اكبر', maxValue: 10, initialCounterValue: 0),
            SizedBox(height: 15),
            CustomContainer(
                title:
