...
class Ahadith29 extends StatelessWidget {
  final String title;
  const Ahadith29({Key? key, required this.title}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return const Scaffold(
      appBar: CustomAppBar(title: 'أبواب الخير '),
      body: SingleChildScrollView(
        child: Column(
          children: [
            SizedBox(height: 15),
            CustomContainer(
                headtitle: 'الحديث التاسع و العشرون',
                title:
