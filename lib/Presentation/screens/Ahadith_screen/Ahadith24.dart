...
class Ahadith24 extends StatelessWidget {
  final String title;
  const Ahadith24({Key? key, required this.title}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return const Scaffold(
      appBar: CustomAppBar(title: 'من فضل الله على الناس '),
      body: SingleChildScrollView(
        child: Column(
          children: [
            SizedBox(height: 15),
            CustomContainer(
                headtitle: 'الحديث الرابع و العشرون',
                title:
