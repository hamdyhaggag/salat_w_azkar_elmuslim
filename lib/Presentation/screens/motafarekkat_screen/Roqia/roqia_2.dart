...
class Roqia2 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const Scaffold(
      appBar: CustomAppBar(title: 'الرقية الشرعية من السنة'),
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            SizedBox(height: 15),
            CustomContainer(
                title: 'يَا حَيُّ يَا قَيُّومُ ، بِرَحْمَتِكَ أَسْتَغِيثُ .',
                maxValue: 1,
                initialCounterValue: 0),
            SizedBox(height: 15),
            CustomContainer(
            ...
            SizedBox(height: 15),
            CustomContainer(
                title: 'اللَّهُ اللَّهُ رَبِّي لَا أُشْرِكُ بِهِ شَيْئًا .',
                maxValue: 1,
                initialCounterValue: 0),
            SizedBox(height: 15),
            CustomContainer(
